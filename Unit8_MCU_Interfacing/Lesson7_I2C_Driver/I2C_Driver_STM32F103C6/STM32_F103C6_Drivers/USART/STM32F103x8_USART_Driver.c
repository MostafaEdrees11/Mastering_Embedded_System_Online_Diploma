/**
 ******************************************************************************
 * @file           : STM32F103x8_USART_Driver.c
...
UART_Configuration_t Gl_UART1_CFG;
UART_Configuration_t Gl_UART2_CFG;
UART_Configuration_t Gl_UART3_CFG;
...
void MCAL_UART_Init(USART_TypeDef *USARTx, UART_Configuration_t *UART_Config)
{
	...
	{
		RCC_USART1_CLK_EN();
		Gl_UART1_CFG = *UART_Config;
		Gl_AUARTx_CFG[USART1_INDEX] = &Gl_UART1_CFG;
	}
	else if(USARTx == USART2)
	{
		RCC_USART2_CLK_EN();
		Gl_UART2_CFG = *UART_Config;
		Gl_AUARTx_CFG[USART2_INDEX] = &Gl_UART2_CFG;
	}
	else if(USARTx == USART3)
	{
		RCC_USART3_CLK_EN();
		Gl_UART3_CFG = *UART_Config;
		Gl_AUARTx_CFG[USART3_INDEX] = &Gl_UART3_CFG;
	}
...
void MCAL_UART_ReceiveData(USART_TypeDef *USARTx, uint16_t *pRxBuffer, enum Polling_Mechnism PollingEn)
{
	...
	if(PollingEn == enable)
		while(!((USARTx->SR >> UART_SR_RXNE) & 1));
...
void MCAL_UART_GPIO_Set_Pins(USART_TypeDef *USARTx)
{
	...
	if(USARTx == USART1)
	{
		...
		if(Gl_AUARTx_CFG[USART1_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS || Gl_AUARTx_CFG[USART1_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
		...
		if(Gl_AUARTx_CFG[USART1_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_RTS || Gl_AUARTx_CFG[USART1_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
	...
	else if(USARTx == USART2)
	{
		...
		//configuration of CTS or RTS or both
		if(Gl_AUARTx_CFG[USART2_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS || Gl_AUARTx_CFG[USART2_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
		...
		if(Gl_AUARTx_CFG[USART2_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_RTS || Gl_AUARTx_CFG[USART2_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
	...
	else if(USARTx == USART3)
	{
		...
		//configuration of CTS or RTS or both
		if(Gl_AUARTx_CFG[USART3_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS || Gl_AUARTx_CFG[USART3_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
		...
		if(Gl_AUARTx_CFG[USART3_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_RTS || Gl_AUARTx_CFG[USART3_INDEX]->UART_HW_FLOW_CTL == UART_HW_FLOW_CTL_CTS_RTS)
		{
